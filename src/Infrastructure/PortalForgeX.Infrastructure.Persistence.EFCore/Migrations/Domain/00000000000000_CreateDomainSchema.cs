        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasCustomerCarePlus = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessLocations_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupAccess", x => new { x.UserGroupId, x.Name });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoftwareVersion = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Remarks = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checkouts_BusinessLocations_BusinessLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_BusinessLocations_BusinessLocationId",
                        column: x => x.BusinessLocationId,
                        principalTable: "BusinessLocations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessLocations_ApiKey",
                table: "BusinessLocations",
                column: "ApiKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BusinessLocations_ClientId",
                table: "BusinessLocations",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_BusinessLocationId",
                table: "Checkouts",
                column: "BusinessLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_DeviceCode",
                table: "Checkouts",
                column: "DeviceCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_BusinessLocationId",
                table: "Payments",
                column: "BusinessLocationId");
